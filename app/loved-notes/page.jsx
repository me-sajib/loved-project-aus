...
async function fetchData() {
  ...
  const response = await storyblokApi.get(`cdn/stories/sending-receiving/loved-notes`, sbParams, { cache: "no-store" });
  return response.data;
}

export default function LovedNotes() { // Changed to start with an uppercase letter

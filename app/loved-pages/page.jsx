...
async function fetchData() {
  ...
  const response = await storyblokApi.get(`cdn/stories/loved-pages`, sbParams, { cache: "no-store" });
  return response.data;
}

export default function LovedPages() { // Changed to start with an uppercase letter

...
async function fetchData() {
  ...
  const response = await storyblokApi.get(`cdn/stories/terms-and-conditions`, sbParams, { cache: "no-store" });
  return response.data;
}

export default function TermsAndConditions() { // Changed to start with an uppercase letter

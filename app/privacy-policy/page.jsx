...
async function fetchData() {
  ...
  const response = await storyblokApi.get(`cdn/stories/privacy`, sbParams, { cache: "no-store" });
  return response.data;
}

export default function PrivacyPolicy() { // Changed to start with an uppercase letter
